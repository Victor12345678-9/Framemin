<head>
        ...
        <!-- preloader css -->
        <link rel="stylesheet" href="<?php echo HTTP_.ROOT_PATH_CORE; ?>/Public/css/preloader.min.css" type="text/css" />
        

<!-- Bootstrap Css -->
        <!-- <link href="../Resources/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" /> -->
        <link href="<?php echo HTTP_.ROOT_PATH_CORE; ?>/Public/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
     
        <!-- Icons Css -->
        <!-- <link href="../Resources/css/icons.min.css" rel="stylesheet" type="text/css" /> -->
        <link href="<?php echo HTTP_.ROOT_PATH_CORE; ?>/Public/css/icons.min.css" rel="stylesheet" type="text/css" />
        <!-- App Css-->
