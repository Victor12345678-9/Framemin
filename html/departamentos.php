                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Layouts">Apps</div>
                        </a>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Departamentos</h4> 
...
<?php foreach ($result as $key){ ?>
            ...
            <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item"  onclick="deleteDepartamento(<?php echo $key['idDepartamento'];?>)"
