                                    ...
                                    <div class="col-md-9">
                                            ...
                                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                                ...
                                                <form class="needs-validation" autocomplete="off" id="nuevo"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-3 position-relative">
                                                                ...
                                                                <input type="text" class="form-control" name="apellido"
                                                                    ...
                                                                    value="<?= $usuarios['apellido']?>" required>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-3 position-relative">
                                                                <label class="form-label" for="lugarNacimiento">Lugar De
                                                                    Nacimiento</label>
                                        ...
                                        if($usuarios['genero']=='Femenino'){
                                           ...
                                           echo '<option value="Masculino" >Masculino</option>';
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-3 position-relative">
                                                                <label class="form-label" for="estadoCivil">Estado
                                                                    Civil</label>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-3 position-relative">
                                                                ...
                                                                <input type="text" class="form-control" name="curp"
                                                                    placeholder="CURP" value="<?= $usuarios['curp']?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-3 position-relative">
                                                                <label class="form-label" for="numeroCartilla">Numero de
                                                                    Cartilla</label>
                                                                <input type="number" class="form-control"
                                                                    name="numeroCartilla"
                                                                    placeholder="Numero de cartilla"
                                                                    value="<?= $usuarios['numeroCartilla']?>" min=0>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="mb-3 position-relative">
                                                            <label class="form-label" for="numeroTelefonico">Numero
                                                                Telefonico</label>
                                                            <input type="text" class="form-control"
                                                                name="numeroTelefonico" placeholder="Numero Telefonico"
                                                                value="<?= $usuarios['numeroTelefonico']?>">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3 position-relative">
                                                            <label class="form-label"
                                                                for="lugarNacimiento">Direccion</label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3 position-relative">
                                                            ...
                                                            <input type="text" class="form-control" name="codigoPostal"
                                                                ...
                                                                value="<?= $usuarios['codigoPostal']?>" min=1>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3 position-relative">
                                                            <label class="form-label" for="nss">Numero de Seguro
                                                                Social</label>
                                                            <input type="number" class="form-control" name="nss"
                                                                placeholder="NSS" value="<?= $usuarios['nss']?>" min=0>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3 position-relative">
                                                            ...
                                                            <input type="text" readonly class="form-control"
                                                                name="nomina" placeholder="Nomina"
                                                                value="<?= $usuarios['nomina']?>" required min=1>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3 position-relative">
                                                            ...
                                                            <select type="number" class="form-select"
                                                                name="departamento"
                                                                value="<?php $usuarios['departamento'] ?>" required>

                                                                <option style="color:grey" disabled>Seleccione Un
                                                                    Departamento</option>
                                        ...
                                        ?>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3 position-relative">
                                                            ...
                                                            <input type="text" class="form-control" name="puesto"
                                                                placeholder="Puesto" value="<?= $usuarios['puesto']?>"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3 position-relative">
                                                            <label class="form-label" for="fechaContratacion">Fecha De
                                                                Contratacion</label>
                                                            <input type="date" class="form-control"
                                                                name="fechaContratacion"
                                                                value="<?= $usuarios['fechaContratacion']?>">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="v-pills-settings" role="tabpanel"
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="checkActivado"
                                                        checked>
