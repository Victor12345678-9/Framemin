                                            ...
                                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                                ...
                                                <form class="needs-validation" autocomplete="off" id="form"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-3 position-relative">
                                                                ...
                                                                <input type="date" id="fechaNacimiento"
                                                                    onblur="calcular_edad(this.value)"
                                                        ...
                                                        <input type="hidden" class="form-control" name="edad"
                                                            placeholder="Edad" id="edad" min=18 requierd>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-3 position-relative">
                                                                ...
                                                                <select type="text" class="form-select" name="genero"
                                                                    ...
                                                                    <option style="color:grey" value="" selected
                                                                        disabled>Seleccione Un Genero</option>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-3 position-relative">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    name="numeroCartilla"
                                                                    placeholder="Numero de cartilla" min=1>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3 position-relative">
                                                            ...
                                                            <input type="text" class="form-control" name="codigoPostal"
                                                                placeholder="Codigo Postal" min=1>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-3 position-relative">
                                                            ...
                                                            <input type="text" class="form-control" name="nomina"
                                                                placeholder="Nomina" required min=1>
