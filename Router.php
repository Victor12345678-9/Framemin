...
public function controllerAdd($class=null, $metohd=null, $httpRes=null, $params=[]){
include('./app/controllers/'.$class.'.php'); 
$controller = new $class;
http_response_code($httpRes);
header("Content-type: application/json; charset=utf-8");
$result = json_encode($controller->$metohd($params));
print_r($result);

}
public function redirect($rute){
header("Location: /lindesk/" . $rute , TRUE, 302);
exit();
